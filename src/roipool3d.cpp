...
int roipool3d_gpu_slow(at::Tensor xyz, at::Tensor boxes3d, at::Tensor pooled_features, at::Tensor pooled_empty_flag){
    // params xyz: (B, N, 3)
    ...
    roipool3dLauncher_slow(batch_size, pts_num, boxes_num, sampled_pts_num, 
                           xyz_data, boxes3d_data, pooled_features_data, pooled_empty_flag_data);
...
int roipool3d_gpu(at::Tensor xyz, at::Tensor boxes3d, at::Tensor pooled_features, at::Tensor pooled_empty_flag){
    // params xyz: (B, N, 3)
    // params boxes3d: (B, M, 7)
    // params pooled_features: (B, M, 512, 3+C)
    // params pooled_empty_flag: (B, M)
    ...
    roipool3dLauncher(batch_size, pts_num, boxes_num, sampled_pts_num, 
                       xyz_data, boxes3d_data, pooled_features_data, pooled_empty_flag_data);
...
int roipool3d_cpu(at::Tensor pts, at::Tensor boxes3d, at::Tensor pooled_pts,
